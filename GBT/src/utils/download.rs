...
use thiserror::Error;
use log::trace;
use crate::utils::{requests_timeout::REQUESTS_TIMEOUT, prettify_bytes::prettify_bytes, free_space};
...
impl Downloader {
    ...
    pub fn download(&mut self, path: impl Into<PathBuf>, progress: impl Fn(u64, u64) + Send + 'static) -> Result<(), DownloadingError> {
        ...
        if self.check_free_space {
            trace!("Checking free space availability");
